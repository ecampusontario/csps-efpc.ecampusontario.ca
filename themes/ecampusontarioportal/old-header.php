...
$englishconfigs=['alternatelangcode'=>'fr','new-search-btn'=>'New Search','alternatelanguage'=>'french','maintitle'=>'Open Library','ecampustitle'=>'eCampusOntario','show-mobile-menu_title'=>'Open mobile menu','switchlanguagebtn_title'=>'change the language','close-mobile-menu_title'=>'Close this menu','quick-search-btn_title'=>'Go','long-search_placeholder'=>'Get started! Search for a resource...','small-search_placeholder'=>'Search for a resource!','switchlanguage'=>'Changer en français'];
$frenchconfigs=['alternatelangcode'=>'en','alternatelanguage'=>'english','new-search-btn'=>'Nouvelle Recherche','maintitle'=>'Bibliothèque Ouverte','ecampustitle'=>'eCampusOntario','show-mobile-menu_title'=>'Oeuvre menu cellulaire','switchlanguagebtn_title'=>'changer la langue','close-mobile-menu_title'=>'Fermer ce menu','quick-search-btn_title'=>'rechercher rapidement pour ce phrase','long-search_placeholder'=>'Rechercher par auteur, titre, ou mots-clés','switchlanguage'=>'Switch to English'];
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-66196714-1"></script>
<script>
...
gtag('config', 'UA-66196714-1');
</script>
<script type="text/javascript" src="/wp-content/themes/ecampusontarioportal/ga_tracker.js"></script>
<script>
...
<head>
    ...
    <script>
    jQuery(function() {
        jQuery('#switchlanguagebtn, #mobileswitchlanguagebtn').click(function() {
